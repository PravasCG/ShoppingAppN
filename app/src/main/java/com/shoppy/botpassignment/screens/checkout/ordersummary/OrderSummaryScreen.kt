package com.shoppy.botpassignment.screens.checkout.ordersummary
...
import com.shoppy.botpassignment.components.OrderSummaryCard
...
//    viewModel.getEmailPhone(email = {})
    ...
    Scaffold(topBar = { BackButton(navController = navController, topBarTitle = "Order Summary", spacing = 60.dp) },
        backgroundColor = ShoppingAppUtils.offWhite, bottomBar = { SummaryBottomBar(totalAmount = totalAmount.value,navController = navController) }) { innerPadding ->
...
fun SummaryBottomBar(totalAmount:Int,navController: NavController){
    ...
    Surface(modifier = Modifier
        ...
        Column(modifier = Modifier.fillMaxSize(), verticalArrangement = Arrangement.SpaceEvenly, horizontalAlignment = Alignment.CenterHorizontally) {
            ...
            PillButton(title = "Continue", color = ShoppingAppUtils.black.toInt()){ navController.navigate(BottomNavScreens.PaymentScreen.route + "/${totalAmount + 280}") }
        }
