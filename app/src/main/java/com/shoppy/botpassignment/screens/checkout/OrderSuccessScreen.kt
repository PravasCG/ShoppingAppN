package com.shoppy.botpassignment.screens.checkout
...
Column(modifier = Modifier
    .fillMaxSize()
    .background(ShoppingAppUtils.offWhite),verticalArrangement = Arrangement.Center, horizontalAlignment = Alignment.CenterHorizontally) {
    ...
    PillButton(title = "Back To Home", color = ShoppingAppUtils.black.toInt(),modifier = Modifier.padding(top = 25.dp)){
