package com.shoppy.botpassignment.screens
...
import com.shoppy.botpassignment.components.TextBox
import com.shoppy.botpassignment.screens.login.LoginViewModel
...
fun ForgotPasswordScreen(navHostController: NavHostController,viewModel: LoginViewModel = androidx.lifecycle.viewmodel.compose.viewModel()){
    ...
    Scaffold(modifier = Modifier.fillMaxSize(), topBar = { BackButton(navController = navHostController, topBarTitle = "Forgot Password", spacing = 50.dp) }, backgroundColor = ShoppingAppUtils.offWhite) { innerPadding ->
        ...
        Column(modifier = Modifier.padding(innerPadding).padding(20.dp).fillMaxSize(), verticalArrangement = Arrangement.Top, horizontalAlignment = Alignment.CenterHorizontally) {
            ...
            PillButton(title = "Find Account", color = ShoppingAppUtils.black.toInt(), modifier = Modifier.padding(top = 10.dp)){
