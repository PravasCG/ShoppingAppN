package com.shoppy.botpassignment.screens.checkout.address
...
import com.shoppy.botpassignment.components.TextBox3
...
fun EditAddressScreen(navController: NavHostController,viewModel: AddressViewModel = androidx.lifecycle.viewmodel.compose.viewModel()) {
    ...
    Scaffold(topBar = { BackButton(navController = navController, topBarTitle = "Edit Address")}, backgroundColor = ShoppingAppUtils.offWhite) { innerPadding ->
        ...
        Column(
            ...
            PillButton(title = "Update Address", color = ShoppingAppUtils.black.toInt(), modifier = Modifier.padding(top = 12.dp)){
