...
fun AddressScreen(navController: NavController,viewModel: AddressViewModel = androidx.lifecycle.viewmodel.compose.viewModel()){
    ...
    Scaffold(topBar = { BackButton(navController = navController, topBarTitle = "Address")}, backgroundColor = ShoppingAppUtils.offWhite) { innerPadding ->
...
//                .padding(top = 0.dp)
            ...
            PillButton(title = "Continue", color = ShoppingAppUtils.black.toInt(), modifier = Modifier.padding(top = 10.dp)){
