package com.shoppy.botpassignment.screens.checkout.payment
...
import com.shoppy.botpassignment.components.BackButton
import com.shoppy.botpassignment.components.PillButton
import com.shoppy.botpassignment.components.ProgressBox
import com.shoppy.botpassignment.components.TextBox2
import com.shoppy.botpassignment.models.MCart
import com.shoppy.botpassignment.navigation.BottomNavScreens
import com.shoppy.botpassignment.screens.checkout.ordersummary.OrderSummaryScreenViewModel
...
fun PaymentScreen(
    ...
    Scaffold(topBar = { BackButton(navController = navController, topBarTitle = "Payment") },
        backgroundColor = ShoppingAppUtils.offWhite, bottomBar = {
            PaymentBottomBar(
        ...
        ConstraintLayout(
            ...
            Surface(
                ...
                Row(
                    ...
                    ProgressBox(number = "1", title = "Address", color = ShoppingAppUtils.blue)
                    Divider(
                        modifier = Modifier
                            .height(2.dp)
                            .width(40.dp)
                    )
                    ProgressBox(number = "2", title = "Order Summary", color = ShoppingAppUtils.blue)
                    Divider(
                        modifier = Modifier
                            .height(2.dp)
                            .width(40.dp)
                    )
                    ProgressBox(number = "3", title = "Payment", color = ShoppingAppUtils.blue)
                }
            }
...
fun CardPayment(
    ...
    Column(
        ...
        TextBox2(value = name.value, onChange = name, placeHolder = "ShoppingApp")
        Text(
...
fun PaymentBottomBar(
    ...
    Column(
        ...
        PillButton(
            title = "Confirm Order",
            color = ShoppingAppUtils.black.toInt(),
