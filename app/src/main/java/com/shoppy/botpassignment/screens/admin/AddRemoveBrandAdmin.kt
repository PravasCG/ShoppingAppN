package com.shoppy.botpassignment.screens.admin
...
import com.shoppy.botpassignment.components.GalleryLaunchComp
import com.shoppy.botpassignment.components.PillButton
import com.shoppy.botpassignment.components.SelectedImageItem
...
fun AddRemoveBrandAdmin(navHostController: NavHostController,viewModel: AdminScreenViewModel = hiltViewModel()){
    ...
    Scaffold(modifier = Modifier.fillMaxSize(), topBar = { BackButton(navController = navHostController, topBarTitle = "Add/Remove Brand", spacing = 30.dp) }, backgroundColor = ShoppingAppUtils.offWhite) { innerPadding ->
        ...
        Column(horizontalAlignment = Alignment.CenterHorizontally,
            ...
            PillButton(title = "Remove Brand", color = ShoppingAppUtils.black.toInt()){
