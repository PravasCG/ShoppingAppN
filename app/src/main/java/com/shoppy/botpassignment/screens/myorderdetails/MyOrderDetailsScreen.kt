package com.shoppy.botpassignment.screens.myorderdetails
...
fun MyOrderDetailsScreen(navController: NavController,
    ...
    Scaffold(
        ...
        Column(
            ...
            val ordered = ShoppingAppUtils.blue
            var onTheWay = Color.Gray
            var delivered = Color.Gray

            if (status == "On The Way") {
                onTheWay = ShoppingAppUtils.blue
            } else if (status == "Delivered") {
                onTheWay = ShoppingAppUtils.blue
                delivered = ShoppingAppUtils.blue
            }
...
//                        .height(60.dp)
                        ...
                        val tint =  if (status == "Cancelled") Color.Red else if (status == "Delivered") Color(0xFFCDDC39) else if (status == "On The Way") ShoppingAppUtils.blue else Color.Black
            ...
            AnimatedVisibility(visible = isEnabled.value) {
                ...
                PillButton(
                    title = "Cancel Order", modifier = Modifier.padding(top = 30.dp, bottom = 20.dp), color = ShoppingAppUtils.black.toInt(), textColor = Color.Red) { openDialog.value = true }
            }
